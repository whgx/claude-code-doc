...
本仓库包含六份完整的 Claude Code 使用手册，涵盖从入门到精通的全方位内容：
...
专为编程新手设计的快速入门教程，30 分钟掌握 Claude Code 基础使用。

**内容包括：**
- Claude Code 是什么
- 详细的安装步骤（macOS/Windows/Linux）
- 第一次使用指南
- 基础功能演示
- 常用命令速查
- 新手常见问题解答
...
**适合人群：** 编程新手、AI 辅助编程初学者、想快速上手的开发者

---

### 🔴 [Java 项目实战指南](./Java项目实战指南.md)
...
- Java 老项目常见问题分析
- 项目评估与扫描方法
- 技术栈升级路径（JDK、Spring、MyBatis）
- 代码质量提升实践
- 性能优化策略
- 完整重构案例（5 年历史项目）
- 常见问题解决方案

**适合人群：** Java 开发者、维护老项目的工程师、技术负责人

---

### 🟣 [前端项目实战指南](./前端项目实战指南.md)
...
- 从零创建 Vue/React 项目
- UI 设计与实现（从设计图到代码）
- 样式美化实践（Tailwind CSS、渐变、阴影）
- 交互与动画（过渡、微交互、加载动画）
- 响应式设计（断点、移动端适配）
- 完整电商网站实战案例
- 常见问题解决

**适合人群：** 前端开发者、UI 设计师转开发、想学习前端的新手
